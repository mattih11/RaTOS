#
# RaTOS Real-Time OS — CommRaT image (layer 2)
#
# SeRTial image + CommRaT communication framework.
...
DESCRIPTION = "RaTOS CommRaT image — EVL + SeRTial + CoreRaT + CommRaT (layer 2, for application development)"
